...
put it in the bridge, and blow up the ship before getting into an
escape pod.
...
can't get the bomb. The code has 3 digits.
""")
...
"""
That code is tricky... ok, Gothons are very predictable. They use
the same code everywhere. It's 0132.
""")
...
of the ship. The do not pull out their weapons, as they see
...
do anything rash with it. I'd suggest placing it down carefully on the
...
"""
In a panic you throw a bomb at a group of Gothons and
make a leap for the door. Right as you drop it, a 
Gothon shoots you in the back, killing you. Regardless of whether the 
Gothons can defuse the device, you're dead. 
""")
...
so your run is clear of interference. You get to the chamber with the escape
...
escapes into the void of space, then implodes as the hull
...
def name_room(room):
    ...
    What's better solution than this global lookup?
    """
